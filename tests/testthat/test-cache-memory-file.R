...
#     cache_fmem_test$add_data(fn_group, "key1", "value1")
#     
#     expect_error(cache_fmem_test$get_data(fn_group, "key2"))
#     
#     cache_fmem_test$terminate()
# })
# 
...
#     cache_group_dir <- fs::path(cache_dir, fn_group)
#     
#     expect_error(cache_fmem_test$delete_data(NULL, "key"))
#     expect_error(cache_fmem_test$delete_data(fn_group, NULL))
#     expect_error(cache_fmem_test$delete_data(NULL, NULL))
#     expect_true(fs::file_exists(fs::path(cache_group_dir, "key")))
#     
#     cache_fmem_test$terminate()
# })
...
#     cache_group_dir <- fs::path(cache_dir, fn_group)
#     
#     expect_error(cache_fmem_test$delete_data(NA, "key"))
#     expect_error(cache_fmem_test$delete_data(fn_group, NA))
#     expect_error(cache_fmem_test$delete_data(NA, NA))
#     expect_true(fs::file_exists(fs::path(cache_group_dir, "key")))
#     
#     cache_fmem_test$terminate()
# })
...
#     cache_group_dir <- fs::path(cache_dir, fn_group)
#     
#     expect_error(cache_fmem_test$delete_data(character(), "key"))
#     expect_error(cache_fmem_test$delete_data(fn_group, character()))
#     expect_error(cache_fmem_test$delete_data(character(), character()))
#     expect_true(fs::file_exists(fs::path(cache_group_dir, "key")))
#     
#     cache_fmem_test$terminate()
# })
...
#     
#     expect_error(
#         cache_fmem_test$delete_data(fn_group, c("key", "key2")))
#     expect_error(
#         cache_fmem_test$delete_data(fn_group, c(NA, "key2")))
#     expect_error(
#         cache_fmem_test$delete_data(c(fn_group, "a_group"), "key2"))
#     expect_true(
#         fs::file_exists(fs::path(cache_group_dir, "key")))
#     
#     cache_fmem_test$terminate()
...
#     
#     expect_error(
#         cache_fmem_test$delete_data(character(), "key"))
#     expect_error(
#         cache_fmem_test$delete_data(fn_group, character()))
#     expect_true(
#         fs::file_exists(fs::path(cache_group_dir, "key")))
#     
#     cache_fmem_test$terminate()
...
#     expect_false(fs::dir_exists(cache_dir))
#     
#     expect_silent(cache_fmem_test$terminate())
# })
