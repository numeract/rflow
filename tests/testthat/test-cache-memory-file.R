...
test_that("forget_group() works", {
    ...
    expect_equal(names(base::get0(
        fn_group, envir = cache_fmem_test$cache_env, inherits = FALSE)), NULL)
...
test_that("list_keys() works", {
    ...
    cache_mem_files <- base::get0(
        fn_group, cache_fmem_test$cache_env, inherits = FALSE)
    expect_equal(
...
test_that("list_keys() works with non-existent group", {
    ...
    expect_false(base::exists(
        "a_group", cache_fmem_test$cache_env, inherits = FALSE)
    )
